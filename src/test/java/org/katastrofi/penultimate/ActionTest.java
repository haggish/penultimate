...
public class ActionTest {
    ...
    @Test
    public void givenEventProducersEventsAreExperiencedByWorld() {
    ...
    @Test
    public void resultsAreOKIfNoneOfThemIsError() {

    }

    @Test
    public void resultsAreNotOKIfAtLeastOneOfThemIsError() {
